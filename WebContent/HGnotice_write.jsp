...
#content>article{ background-color: rgba(0,0,0,0);}
...
<h2 id="contentmain">Picture Request</h2>
	...
	<article>
		...
		<tbody>
				...
				<tr>
					<th>비밀번호:</th>
					<td align="left"><input type="password" name="pwd" size="12"/></td>
				</tr>
				<tr>
					<th>그림이미지:</th>
					<td align="left"><input type="file" name="file_name" size="12"/></td>
				</tr>
				<tr>
					<th>그림정보:</th>
					<td>
